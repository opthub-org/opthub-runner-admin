...
from opthub_runner.models.score import save_success_score, save_failed_score
...
from opthub_runner.lib.keys import QUEUE_NAME, ACCESS_KEY_ID, SECRET_ACCESS_KEY, REGION_NAME, TABLE_NAME
...
def calculate_score(ctx, **kwargs):
    ...
    while True:
        ...
        try:
            ...
            evaluation = fetch_success_evaluation_by_primary_key(kwargs["match_id"],
